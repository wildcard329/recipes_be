...
const getUserByEmail = (email) => db.query('SELECT * FROM users WHERE email = $1', [email]);

const addUser = ({ username, password, email, timestamp }) => db.query('INSERT INTO users (user_name, password, email, created_on) VALUES ($1, $2, $3, to_timestamp($4/1000.0)) RETURNING user_id', [username, password, email, timestamp]);
