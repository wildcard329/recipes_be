...
const addSubRecipeIngredientWithoutUnit = (subRecipeId, ingredientId, amount) => db.query('INSERT INTO sub_recipe_ingredients (sub_recipe_id, ingredient_id, quantity) VALUES ($1, $2, $3)', [subRecipeId, ingredientId, amount]);

const addSubRecipeIngredientWithoutAmount = (subRecipeId, ingredientId) => db.query('INSERT INTO sub_recipe_ingredients (sub_recipe_id, ingredient_id) VALUES ($1, $2)', [subRecipeId, ingredientId]);
