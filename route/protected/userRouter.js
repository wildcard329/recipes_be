...
router.get('/:id', async (req, res) => await serverRes.compileRes(res, users.getUserById, parseInt(req.params.id)));
...
router.delete('/:id', async (req, res) => await serverRes.compileRes(res, users.removeUser, parseInt(req.params.id)));
